...
def move_forward(
    robot, left_wheel, right_wheel, distance, front_ir, speed=47.6
):
    """
...
def correct_trajectory(
    robot, left_wheel, right_wheel, left_ir, right_ir, back_ir, speed=47.6
):
    """
...
def turn(robot, left_wheel, right_wheel, speed=47.6, direction="left"):
    """
...
def wall_follow(robot, left_wheel, right_wheel, ir_sensor_list, speed=47.6):
    """
...
def turn_gyro(robot, left_wheel, right_wheel, gyro, speed=47.6, direction="left"):
    """
